...
void USBFS_MIDI_EP_Init(void) 
{
    ...
    *
    *******************************************************************************/
    void USBFS_MIDI_OUT_EP_Service(void) CYREENTRANT
    {
    ...
    *
    *******************************************************************************/
    void USBFS_MIDI_IN_Service(void) CYREENTRANT
    {
...
*/
    ...
    *
    *******************************************************************************/
    uint8 USBFS_MIDI1_GetEvent(void) CYREENTRANT
    {
        uint8 msgRtn = 0u;
        uint8 rxData;
    ...
    *
    *******************************************************************************/
    uint8 USBFS_MIDI2_GetEvent(void) CYREENTRANT
    {
        uint8 msgRtn = 0u;
        uint8 rxData;
